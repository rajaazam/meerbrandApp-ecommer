  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Center(child: Text('Profiel page')),
        ...
        child: Container(
          ...
          children: [
            ...
            backgroundImage: AssetImage('images/man.jpg'),
                  ...
                  //     height: 100,
                  //     width: 100,
                  //     child: Center(child: Image.asset('images/man.jpg', fit: BoxFit.cover),
                  //    )
            ...
            Text('Azam Khan',style: TextStyle(fontSize: 20,color: Colors.black),),
...
//         FirebaseStorage.instance.ref().child("UserImage/$userUid") as StorageReference;
